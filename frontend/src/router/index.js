...
import ShowOtherYoung from '@/components/ShowOtherYoung.vue';
import ShowOtherOld from '@/components/ShowOtherOld.vue';
const routes = [
  ...
  { path: '/showotheryoung', component: ShowOtherYoung },
  { path: '/showotherold', component: ShowOtherOld }
];
